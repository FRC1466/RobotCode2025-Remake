...
/**
 * Central manager for subsystem testing. Coordinates test execution, subsystem isolation, and
 * result reporting.
 */
public class TestManager extends SubsystemBase {
  ...
  public TestManager() {
    ...
    testModeChooser.addOption(SubsystemTestMode.MANUAL.getName(), SubsystemTestMode.MANUAL);
  }
  ...
  public boolean isSubsystemActive(String subsystemName) {
    ...
    return switch (currentTestMode) {
      ...
      case PIVOT ->
          subsystemName.equalsIgnoreCase("Pivot") || subsystemName.equalsIgnoreCase("Wrist");
      case INTAKE -> subsystemName.equalsIgnoreCase("Intake");
      case VISION -> subsystemName.equalsIgnoreCase("Vision");
      case MANUAL ->
          subsystemName.equalsIgnoreCase("Elevator") || subsystemName.equalsIgnoreCase("Pivot");
      default -> false;
    };
  }
