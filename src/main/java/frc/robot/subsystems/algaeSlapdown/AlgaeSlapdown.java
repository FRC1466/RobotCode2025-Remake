...
/** The AlgaeSlapdown subsystem controls the slapdown arm rotation using a simple state machine. */
public class AlgaeSlapdown extends SubsystemBase {
  ...
  private final AlgaeSlapdownIO io;
  private final AlgaeSlapdownIOInputsAutoLogged inputs = new AlgaeSlapdownIOInputsAutoLogged();
  ...
  public AlgaeSlapdown(AlgaeSlapdownIO io) {
    this.io = io;
  ...
  public void periodic() {
    ...
    Logger.processInputs("Subsystems/AlgaeSlapdown", inputs);
    ...
    applyStates();
    logState();
    LoggedTracer.record("AlgaeSlapdown");
  }
  ...
  private void logState() {
    Logger.recordOutput("Subsystems/AlgaeSlapdown/SystemState", systemState.name());
    Logger.recordOutput("Subsystems/AlgaeSlapdown/WantedState", wantedState.name());
    Logger.recordOutput("Subsystems/AlgaeSlapdown/GoalAngle", goalAngle);
    Logger.recordOutput("Subsystems/AlgaeSlapdown/AtGoal", atGoal());
