...
public class CoralSlapdownConstants {
  // Motor IDs
  ...
  // PID Constants
  public static final LoggedTunableNumber kP = new LoggedTunableNumber("CoralSlapdown/kP", 8);
  public static final LoggedTunableNumber kI = new LoggedTunableNumber("CoralSlapdown/kI", 0.0);
  public static final LoggedTunableNumber kD = new LoggedTunableNumber("CoralSlapdown/kD", 0.0);
  public static final LoggedTunableNumber kG = new LoggedTunableNumber("CoralSlapdown/kG", 0.0);
  public static final LoggedTunableNumber kS = new LoggedTunableNumber("CoralSlapdown/kS", 0.0);
  ...
  public static final LoggedTunableNumber stowedPosition =
      new LoggedTunableNumber("CoralSlapdown/StowedPosition", 0.0);

  public static final LoggedTunableNumber intakePosition =
      new LoggedTunableNumber("CoralSlapdown/IntakePosition", Units.degreesToRadians(225));
}
